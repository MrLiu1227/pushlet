...
<script type="text/javascript">
	using('jqupload', function() {
		...
		var upload = $form.find('#uploadAttach').slwUpload({
		...
		$(".fileRow", $form).each(function() {
			...
			$.jquploadUtil.initTools($(this).attr('id'), upload.option, delCallback, $form); //readonly=false 编辑模式 1:重命名 下载 删除 ; readonly=true 查看模式 3:只有下载
		});
	});
</script>
