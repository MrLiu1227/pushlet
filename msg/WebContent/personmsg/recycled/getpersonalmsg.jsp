...
<form class="form-horizontal form-validate" method="post"  <ww:if test="uuid != null">action="recycled/updPersonalMsg.action"</ww:if><ww:else>action="recycled/addPersonalMsg.action"</ww:else> onsubmit="return $action.submit(this);">
        <ww:cssToken />
...
<div class="content" style="min-width: 500px;">
	<div class="box box-primary with-border">
		<div class="box-header with-border">
			<h3 class="box-title"><ww:if test="uuid != null">修改</ww:if><ww:else>添加</ww:else>信息</h3>
  ...
  <table class="table table-bordered editTable form-group-sm">
	  ...
	  <tr>
		  <td colspan="3" class="tdLable">
			  消息名称</td>
		  <td colspan="9">
			  <input type="text" maxlength="100" placeholder="请输入消息名称"  class="form-control" name="msgName" id="msgName" value="<ww:property value='item.msgName'/>" >
		  </td>
	  </tr>
		<tr>
			<td colspan="3" class="tdLable">
				消息类型</td>
    		<td colspan="9">
		 		 <ww:select attributes="class='form-control'" name="msgType" id="msgType" value="item.msgType"  list="#dictID.getDictListSel('d_root','d_sex')" listKey="code" listValue="name"></ww:select>
			</td>
		</tr>
		<tr>
			<td colspan="3" class="tdLable">
				消息内容</td>
    		<td colspan="9">
		  	<input type="text" maxlength="100" placeholder="请输入消息内容"  class="form-control" name="msgContent" id="msgContent" value="<ww:property value='item.msgContent'/>" >
			</td>
		</tr>
		<tr>
			<td colspan="3" class="tdLable">
				消息关键字</td>
    		<td colspan="9">
		  	<input type="text" maxlength="100" placeholder="请输入消息关键字"  class="form-control" name="msgKeyWord" id="msgKeyWord" value="<ww:property value='item.msgKeyWord'/>" >
			</td>
		</tr>
		<tr>
			<td colspan="3" class="tdLable">
				发送方</td>
    		<td colspan="9">
		  	<input type="text" maxlength="100" placeholder="请输入发送方"  class="form-control" name="sender" id="sender" value="<ww:property value='item.sender'/>" >
			</td>
		</tr>
		<tr>
			<td colspan="3" class="tdLable">
				接收者</td>
    		<td colspan="9">
		  	<input type="text" maxlength="100" placeholder="请输入接收者"  class="form-control" name="receiver" id="receiver" value="<ww:property value='item.receiver'/>" >
			</td>
		</tr>
		<tr>
			<td colspan="3" class="tdLable">
